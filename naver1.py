...
os.environ["LANGSMITH_API_KEY"] = "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"  # 발급받은 API 키 입력
os.environ["LANGSMITH_PROJECT"] = "naver_shopping_ai2"  # 프로젝트 이름 (설정하지 않으면 "default"로 지정됨)
